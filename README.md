...
- `book-01-ai-in-healthcare-dos-and-donts/launch-kit.md` — LinkedIn + Pinterest + YouTube marketing posts
- `book-01-ai-in-healthcare-dos-and-donts/author-identity-sheet.md` — official author profile & links
- `book-01-ai-in-healthcare-dos-and-donts/book-2-to-8-outlines.md` — outlines for the rest of the series
- `book-01-ai-in-healthcare-dos-and-donts/assets/` — covers (add PNG/JPG here) and YouTube brand assets

## Above this folder

- `backup-guide.md` — 3-2-1 backup workflow (this repo is copy #1)
