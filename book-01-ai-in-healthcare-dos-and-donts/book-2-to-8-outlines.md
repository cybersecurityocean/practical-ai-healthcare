...
**Price:** $4.99–$7.99.
**USP (why it stands out):** No other beginner book explains HIPAA + GDPR + India's DPDP Act 2023 side-by-side in plain language with an AI-specific lens.

**Outline (12 chapters):**
1. Why Data Protection Is the #1 AI Risk in Healthcare
2. What "Sensitive Data" Actually Means (PHI, personal data, health data)
...
**Price:** $7.99–$9.99.
**USP:** A decision-maker's playbook with phases, gates, and templates — not another "AI will change everything" book.

**Outline (14 chapters):**
1. Why Most AI Programs Fail (and How to Avoid It)
2. Building the AI Governance Structure (committee, owners, budget)
...
6. Vendor Selection & Procurement (contracts, pilots, exit clauses)
7. The Pilot Playbook: Scope, Metrics, and Gates
8. Integration: Making AI Fit Real Workflows (not the reverse)
...
12. The Compliance & Ethics Gates (HIPAA/DPDP, bias, explainability)
...
**Price:** $7.99–$9.99.
**USP:** Positions *you* as the analyst who bridges healthcare + AI; doubles as your portfolio/resume proof.

**Outline (12 chapters):**
1. The BA's Role in the AI Era (Why You're Essential)
2. The BA Toolkit: AI Tools for Analysis, Dashboards, and Reports
3. Requirements Gathering with AI: Prompts for Stakeholder Interviews
...
11. The BA + AI Career Path: Skills, Certifications, Portfolio
12. BA Playbook: 25 AI Prompts + Templates (printable)

**Cross-sell:** your personal-branding book — most resume-relevant of the five.
...
**Price:** $4.99–$7.99.
**USP:** The most practical book — pure templates + examples; instantly usable.

**Outline (10 chapters + appendix):**
1. Prompting Basics: How AI Responds (Plain Language)
2. The PROMPT Framework (Problem → Role → Objective → Method → Parameters → Tone)
3. Prompts for Documenting Processes and Pain Points
4. Prompts for Requirements Gathering and Stakeholder Interviews
5. Prompts for Data Cleaning, Analysis, and Reports
6. Prompts for Clinical Documentation and Summaries
7. Prompts for Compliance Research (DPDP, HIPAA, GDPR summaries)
8. Prompts for Project Scoping and BRD/PRD Drafting
...
**Price:** $4.99–$7.99.
**USP:** The anti-hype, evidence-based answer to the question everyone is asking. No fear, no fairy tales — just a clear framework for what changes and what doesn't.

**Outline (12 chapters):**
1. The Question Everyone Is Asking (and Why It's Framed Wrong)
2. What AI Can Do Today (and What It Truly Cannot)
3. The 3 Categories: Replaced, Redefined, Untouched
4. Augmentation vs. Replacement: The Real History of Tech in Healthcare
5. Why Human Judgment, Accountability, and Empathy Can't Be Automated
6. Which Roles Are at Risk (Honest Answer) — and Which Are Safe
7. The Human-in-the-Loop Future: New Jobs AI Creates
8. How Clinicians and Staff Can Stay Relevant (Skills Playbook)
9. What Patients Want: The Trust Factor
10. What the Evidence Says: Studies, Pilots, and Real Deployments
...
**Price:** $7.99–$9.99.
**USP:** A practical decision framework for a question almost no book answers for healthcare specifically: where does the AI and its data actually live?

**Outline (12 chapters):**
1. The Question That Stalls Every AI Project: Where Does It Run?
2. The Three Options: On-Premise (internal server), Cloud, Hybrid
3. Security: What Each Option Actually Protects (and What It Doesn't)
4. Compliance: Data Residency, Cross-Border Rules (DPDP), HIPAA/GDPR Storage
5. The Vendor Factor: Where Does Your Vendor Store Data?
6. Cost Reality: CAPEX vs. OPEX, and the Hidden Costs
7. Performance & Latency: When Cloud Is Too Slow, When It's Fine
8. AI Model Training vs. Inference: Different Homes, Different Needs
9. The Hybrid Approach: Best of Both — or Worst of Both?
10. The Decision Framework: 15 Questions Before You Choose
...
**Price:** $7.99–$9.99.
**USP:** Most "future of healthcare AI" content is hype. This one is a grounded, evidence-based forecast with concrete timelines and a personal preparation plan — no crystal-ball promises.

**Outline (12 chapters):**
1. Why Most Predictions Fail (and How to Read a Forecast Honestly)
2. The 5-Year Horizon: What's Realistic by 2030
3. The 10-Year Horizon: What's Plausible by 2035
4. Clinical AI: From Support to Standard Practice (Diagnostics, Triage, Monitoring)
5. Administrative AI: The Quiet Revolution (Documentation, Scheduling, Billing)
...
**Cross-sell:** the "big picture" capstone that ties all other books together; strong YouTube topic (below).
...
`[LINK]` (in marketing copy). Author bio is already locked: Mohammed Imthiyaz A — Senior QA & BA, Healthcare IT, 10+ years, AI automation.
