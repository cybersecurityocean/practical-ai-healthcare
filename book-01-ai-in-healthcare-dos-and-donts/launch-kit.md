...
## PART A — LINKEDIN (posts ready to copy-paste)
...
**Post 2 (hook — mistakes list)**
> 15 things hospitals get wrong with AI (and how to fix them):
>
> 1. Buying tools before defining the problem
> 2. Trusting the vendor's demo instead of their own data
> 3. No human in the loop
> 4. Skipping the bias check
> 5. No failure plan
> 6. Treating accuracy as the only metric
> 7. Dismantling the manual process too early
> 8. No monitoring after launch
> 9. Ignoring data privacy rules (HIPAA / DPDP)
...
>
> "What decision will this change, and who will act on it?"
>
...
> • Weeks 1–2: inventory your processes (buy nothing)
> • Weeks 3–6: pick ONE boring, measurable win
...
**Posting schedule:** 3×/week (Tue, Thu, Sat, 9–10 AM IST). Rotate the 8 posts, then reuse formats for Books 2–5.

---

## PART B — PINTEREST (setup + pins ready)

**Setup (once):**
- Create a **Business** account (free) — personal accounts can't link properly.
- Name: author brand. Add website = Gumroad link.
...
- Myth pins: "5 AI in Healthcare Myths"
- Book cover pins: 5 variations

**Rhythm:** 5 pins/day across boards. Use Pinterest's free scheduler. Consistency beats volume.

---

## PART C — YOUTUBE (channel + first videos)

**Channel setup (once):**
- Channel name: `Mohammed Imthiyaz A — HealthAI` (or your brand).
- Handle: `@HealthAI_Insights`.
- Faceless format: screen recording + voice (your voice or AI voice) over Canva slides.
...
2. Value (80% of video): the content
...
**Thumbnail:** big text + book cover (Canva). E.g., "15 AI Mistakes in Hospitals".

**Rhythm:** 1–2 videos/week.

> ⚠️ YouTube monetization needs 1,000 subs + 4,000 watch hours — irrelevant here. The videos exist to drive book downloads, not ad revenue.
